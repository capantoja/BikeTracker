 ...
 * Board identifier.
 */
#define BOARD_BikeTracker
#define BOARD_NAME                  "BikeTracker"
 ...
 */
#define GPIOA_LED                   0
#define GPIOA_ON_GSM                1
#define GPIOA_ON_GPS                2
#define GPIOA_PIN3                  3
#define GPIOA_PIN4                  4
#define GPIOA_PIN5                  5
#define GPIOA_PIN6                  6
 ...
 * PA1  - PIN1                      (output pushpull).
 * PA2  - PIN2                      (output pushpull).
...
#define VAL_GPIOA_MODER             (PIN_MODE_OUTPUT(GPIOA_LED) |           \
                                     PIN_MODE_OUTPUT(GPIOA_ON_GSM) |        \
                                     PIN_MODE_OUTPUT(GPIOA_ON_GPS) |        \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_LED) |        \
                                     PIN_OTYPE_PUSHPULL(GPIOA_ON_GSM) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_ON_GPS) |     \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_2M(GPIOA_LED) |             \
                                     PIN_OSPEED_2M(GPIOA_ON_GSM) |          \
                                     PIN_OSPEED_2M(GPIOA_ON_GPS) |          \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_LED) |        \
                                     PIN_PUPDR_FLOATING(GPIOA_ON_GSM) |     \
                                     PIN_PUPDR_FLOATING(GPIOA_ON_GPS) |     \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_LED) |              \
                                     PIN_ODR_HIGH(GPIOA_ON_GSM) |           \
                                     PIN_ODR_HIGH(GPIOA_ON_GPS) |           \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_LED, 0) |            \
                                     PIN_AFIO_AF(GPIOA_ON_GSM, 0) |         \
                                     PIN_AFIO_AF(GPIOA_ON_GPS, 0) |         \
 ...
 * PB8  - PIN8                      (alternate i2c).
 * PB9  - PIN9                      (alternate i2c).
 * PB10 - PIN10                     (input pullup).
 * PB11 - PIN11                     (input pullup).
 * PB12 - PIN12                     (output puspull).
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_PIN_SAO) |    \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_PIN_SAO) |      \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_PIN8, 1) |           \
                                     PIN_AFIO_AF(GPIOB_PIN9, 1) |           \
                                     PIN_AFIO_AF(GPIOB_PIN10, 0) |          \
                                     PIN_AFIO_AF(GPIOB_PIN11, 0) |          \
                                     PIN_AFIO_AF(GPIOB_PIN_SAO, 0) |        \
